<%
 ...
 If InStr(iname,"<") < 1 Then 
   ...
   NicksFile = Server.MapPath("/Chat/Nicks.txt")	
   Set InStream = FileObject.OpenTextFile(NicksFile, 1, false)
   ...
   If Not IsError Then
     Set FileObject = CreateObject("Scripting.FileSystemObject")
     NicksFile = Server.MapPath("/Chat/Nicks.txt")	
     Set OutStream = FileObject.OpenTextFile(NicksFile, 8, true)
     OutStream.WriteLine (Iname)
     OutStream.WriteLine (Iname)
...
<Form name="Nickname" method="post" action="Entrance.asp">
 ...
 <table width= 400 border = 1>
  ...
  <tr>
   ...
   <INPUT TYPE="radio" NAME="user_color" VALUE="#000000" CHECKED> <FONT COLOR="#000000">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#0000FF"> <FONT COLOR="#0000FF">Текст<BR>
   <INPUT TYPE="radio" NAME="user_color" VALUE="#FF0000"> <FONT COLOR="#FF0000">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#800080"> <FONT COLOR="#800080">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#008000"> <FONT COLOR="#008000">Текст<br>
   <INPUT TYPE="radio" NAME="user_color" VALUE="#CC0000"> <FONT COLOR="#CC0000">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#FF00FF"> <FONT COLOR="#FF00FF">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#808080"> <FONT COLOR="#808080">Текст<br>
   <INPUT TYPE="radio" NAME="user_color" VALUE="#A020F0"> <FONT COLOR="#A020F0">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#800000"> <FONT COLOR="#800000">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#000080"> <FONT COLOR="#000080">Текст<br>
   <INPUT TYPE="radio" NAME="user_color" VALUE="#808000"> <FONT COLOR="#808000">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#FF9900"> <FONT COLOR="#FF9900">Текст <INPUT TYPE="radio" NAME="user_color" VALUE="#008080"> <FONT COLOR="#008080">Текст<br>
   </FONT>
   </td>
  </tr>
